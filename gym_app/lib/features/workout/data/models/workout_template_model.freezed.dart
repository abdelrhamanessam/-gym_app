...
mixin _$WorkoutTemplateModel {
  ...
  List<TemplateExerciseModel> get exercises =>
...
class _$WorkoutTemplateModelImpl implements _WorkoutTemplateModel {
  const _$WorkoutTemplateModelImpl(
      ...
      this.goal,
      final List<TemplateExerciseModel> exercises = const [],
  ...
  @override
  final String? goal;
  final List<TemplateExerciseModel> _exercises;
  @override
  @JsonKey()
  List<TemplateExerciseModel> get exercises {
  ...
  @override
  String toString() {
    return 'WorkoutTemplateModel(id: $id, userId: $userId, name: $name, description: $description, difficulty: $difficulty, goal: $goal, exercises: $exercises, estimatedDuration: $estimatedDuration, createdAt: $createdAt)';
  }
...
abstract class _WorkoutTemplateModel implements WorkoutTemplateModel {
  const factory _WorkoutTemplateModel(
      ...
      final int estimatedDuration,
      required final String createdAt}) = _$WorkoutTemplateModelImpl;
