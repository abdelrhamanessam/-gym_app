...
class _$WorkoutTemplateImpl implements _WorkoutTemplate {
  ...
  @override
  String toString() {
    return 'WorkoutTemplate(id: $id, userId: $userId, name: $name, description: $description, difficulty: $difficulty, goal: $goal, exercises: $exercises, estimatedDuration: $estimatedDuration, createdAt: $createdAt)';
  }
...
abstract class _WorkoutTemplate implements WorkoutTemplate {
  const factory _WorkoutTemplate(
      ...
      final int estimatedDuration,
      required final DateTime createdAt}) = _$WorkoutTemplateImpl;
